...
def run_test_sum_sequence():
    ...
    # -------------------------------------------------------------------------
    # DO: 2. READ the COMMENTS and CODE in this function,
...
def run_test_count_items_bigger_than():
    ...
    # DO 4 (continued):  Add your 2 ADDITIONAL tests here:
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 1
    actual = count_positive_sines([3.1])
    print()
    print('Test 5 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = 100
    actual = sum_first_n([40, 60, 0, 5], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
